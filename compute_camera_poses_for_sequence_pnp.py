...
def initialize(fast, orb, camera_matrix, kf_idx=[1000, 1050]):
    ...
    matches, last_pts, current_pts, match_frame = match(keyframes[0]["frame"],
        keyframes[1]["frame"], bf, keyframes[0]["des"], keyframes[1]["des"],
        keyframes[0]["kp"], keyframes[1]["kp"], draw=False)
